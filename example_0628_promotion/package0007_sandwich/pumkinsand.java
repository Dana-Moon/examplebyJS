...
public class pumkinsand extends childClass_sandwich_anotherPackage{
  
        //이렇게 만들다 보니 다른 샌드위치와 차이가 없네요..
        public pumkinsand(String name, String bread, String butter, String material_1, String material_2 ){
            super(name, bread, butter, material_1, material_2);
        }

        public pumkinsand(String name, String bread, String butter, String material_1){
            super(name, bread, butter, material_1);
        }
