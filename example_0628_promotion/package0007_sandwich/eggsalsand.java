...
public class eggsalsand extends childClass_sandwich_anotherPackage{

        //이렇게 만들다 보니 다른 샌드위치와 차이가 없네요..
        public eggsalsand(String name, String bread, String butter, String material_1, String material_2 ){
